...
export const PastBookingsView = () => {
  return (
    <div className="w-full animate-fade-in flex flex-col items-center justify-center py-20 px-4 mt-8 bg-gray-50 rounded-3xl border border-gray-200 shadow-sm">
      ...
      <Text typography="t4" fontWeight="bold" className="text-gray-900 mb-2 text-center">
        과거 예매 조회 페이지는 준비 중입니다.
      </Text>
      <Text typography="t6" className="text-gray-500 text-center max-w-md leading-relaxed">
