    ...
    <>
      ...
      {isConflictModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
          <div className="bg-surface rounded-3xl w-full max-w-[400px] shadow-2xl overflow-hidden animate-slide-up relative flex flex-col">
            <div className="p-8 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-danger-light text-danger rounded-full flex items-center justify-center mb-6">
              ...
              <h2 className="text-2xl font-black text-content mb-3">이미 선점된 좌석입니다</h2>
              <p className="text-content-tertiary text-[15px] leading-relaxed mb-8">
                선택하신 좌석 중 누군가 먼저 결제를 진행 중인 좌석이 포함되어 있습니다. 좌석을 다시 선택해 주세요.
              </p>
              <button
                onClick={handleCloseConflictModal}
                className="w-full bg-danger-hover hover:bg-danger-hover text-white font-bold text-[16px] py-4 rounded-xl transition-colors shadow-md shadow-red-600/20 active:scale-95"
              >
                다시 선택하기
              </button>
            </div>
