...
export const MOCK_LOGIN_EVENT_ID =
  normalizeEventId(process.env.NEXT_PUBLIC_MOCK_LOGIN_EVENT_ID);
...
export const isMockLoginEvent = (eventId?: string | number | null) =>
  !!MOCK_LOGIN_EVENT_ID && normalizeEventId(eventId) === MOCK_LOGIN_EVENT_ID;

export const isMockBookingCompleteEvent = (eventId?: string | number | null) =>
  !!MOCK_BOOKING_COMPLETE_EVENT_ID && normalizeEventId(eventId) === MOCK_BOOKING_COMPLETE_EVENT_ID;
