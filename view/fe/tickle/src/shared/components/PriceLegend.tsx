...
export const PriceLegend = ({ prices, viewMode = 'grade' }: PriceLegendProps) => {
  ...
  return (
    <div className="absolute top-4 left-4 z-20 group">
      ...
      <div className="absolute top-full left-0 mt-3 w-64 p-4 bg-white dark:bg-zinc-800 rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform -translate-y-2 group-hover:translate-y-0">
        ...
        {!isCongestionMode && (
          <>
            ...
            <div className="border-t border-gray-100 dark:border-zinc-700 pt-3">
              <h4 className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-2">좌석 상태 안내</h4>
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2 text-sm">
                  <span className="block w-3 h-3 shrink-0 rounded-full bg-[var(--seat-disabled-top)]"></span>
                  <span className="font-medium text-gray-600 dark:text-gray-300">선택 불가 (예매 완료)</span>
                </div>
        ...
        {isCongestionMode && (
          <div>
            <h4 className="text-sm font-extrabold text-gray-900 dark:text-white mb-3">대기 혼잡도 안내</h4>
            <div className="flex flex-col gap-1 px-1">
              <div className="w-full h-3 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-600 shadow-inner"></div>
              <div className="flex justify-between text-[11px] font-bold text-gray-500 dark:text-gray-400 mt-1">
                <span>보통</span>
                <span>혼잡</span>
                <span>매우 혼잡</span>
              </div>
