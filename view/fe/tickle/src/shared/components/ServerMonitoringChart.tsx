      ...
      <header className="border-b border-line p-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div className="min-w-0">
            <p className="text-[12px] font-bold text-primary">Server monitoring</p>
          ...
          <div className="grid gap-3 sm:grid-cols-3 xl:min-w-[560px]">
            <div className="rounded-lg border border-line bg-surface-subtle px-4 py-3">
              <p className="text-[11px] font-bold text-content-tertiary">현재 접속</p>
              ...
              <p className={`mt-1 text-[11px] font-black ${activeUserDiff >= 0 ? 'text-primary' : 'text-content-tertiary'}`}>
                {activeUserDiff >= 0 ? '+' : ''}
            ...
            <div className="rounded-lg border border-line bg-surface-subtle px-4 py-3">
              <p className="text-[11px] font-bold text-content-tertiary">피크 접속</p>
            ...
            <div className="rounded-lg border border-line bg-surface-subtle px-4 py-3">
              <p className="text-[11px] font-bold text-content-tertiary">평균 접속</p>
