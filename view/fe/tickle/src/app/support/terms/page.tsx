      ...
      <main className="flex-1 w-full flex flex-col px-6 pt-0 pb-12 md:px-10 md:pb-16 relative">
        ...
        <div className="max-w-5xl mx-auto w-full mt-8 flex flex-col mb-12">
          ...
          <Box variant="flat" padding="large" className="bg-white border border-gray-100 rounded-xl w-full text-gray-600 leading-relaxed text-[15px] shadow-sm">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-4">제4조 (회원가입 및 계정 관리)</h2>
            <p className="mb-8">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-4">제5조 (서비스의 제공 및 변경)</h2>
            <p className="mb-8">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-4">제6조 (결제 및 환불)</h2>
            <p className="mb-8">
